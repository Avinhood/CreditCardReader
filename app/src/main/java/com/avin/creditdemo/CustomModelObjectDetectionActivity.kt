...
import com.avin.creditdemo.camera.CameraSource
import com.avin.creditdemo.camera.CameraSourcePreview
import com.avin.creditdemo.camera.GraphicOverlay
import com.avin.creditdemo.camera.WorkflowModel
import com.avin.creditdemo.camera.WorkflowModel.WorkflowState
import com.avin.creditdemo.objectdetection.MultiObjectProcessor
import com.avin.creditdemo.objectdetection.ProminentObjectProcessor
import com.avin.creditdemo.productsearch.BottomSheetScrimView
import com.avin.creditdemo.productsearch.Product
import com.avin.creditdemo.productsearch.ProductAdapter
import com.avin.creditdemo.settings.PreferenceUtils
import com.avin.creditdemo.settings.SettingsActivity
    ...
    private fun startCameraPreview() {
        ...
        if (!workflowModel.isCameraLive) {
            try {
                ...
                Log.e(com.avin.creditdemo.CustomModelObjectDetectionActivity.Companion.TAG, "Failed to start camera preview!", e)
                cameraSource.release()
        ...
        bottomSheetBehavior?.setBottomSheetCallback(
            object : BottomSheetBehavior.BottomSheetCallback() {
                override fun onStateChanged(bottomSheet: View, newState: Int) {
                    Log.d(com.avin.creditdemo.CustomModelObjectDetectionActivity.Companion.TAG, "Bottom sheet new state: $newState")
    ...
    private fun setUpWorkflowModel() {
        workflowModel = ViewModelProviders.of(this).get(WorkflowModel::class.java).apply {
            ...
            workflowState.observe(this@CustomModelObjectDetectionActivity, Observer { workflowState ->
                ...
                Log.d(com.avin.creditdemo.CustomModelObjectDetectionActivity.Companion.TAG, "Current workflow state: ${workflowState.name}")
            ...
            objectToSearch.observe(this@CustomModelObjectDetectionActivity, Observer { detectObject ->
                val productList: List<Product> = detectObject.labels.map { label ->
                    ...
                    Log.e(com.avin.creditdemo.CustomModelObjectDetectionActivity.Companion.TAG, "searched: " + label.text)
