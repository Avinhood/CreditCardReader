...
package com.avin.creditdemo.objectdetection
...
import com.avin.creditdemo.InputInfo
import com.avin.creditdemo.camera.CameraReticleAnimator
import com.avin.creditdemo.camera.FrameProcessorBase
...
class ProminentObjectProcessor(
    ...
    init {
        ...
        Log.e(TAG,"engine initialized: " + resultToString(result!!))  // here
    }
